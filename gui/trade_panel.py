...
class TradePanel(QWidget):
    ...
    def _init_ui(self):
        ...
        self.buy_btn.setFixedHeight(36)
        self.buy_btn.setToolTip("提交买入订单")
        self.buy_btn.setAccessibleName("买入")
        ...
        self.sell_btn.setToolTip("提交卖出订单")
        self.sell_btn.setAccessibleName("卖出")
